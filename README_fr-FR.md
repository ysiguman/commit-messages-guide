# Guide de commits messages

[![Say Thanks!](https://img.shields.io/badge/Say%20Thanks-!-1EAEDB.svg)](https://saythanks.io/to/RomuloOliveira)

Un guide pour comprendre l'importance des commits messages et comment bien les écrire.

Il vas vous aider a apprendre qu'est-ce qu'un commit, pourquoi c'est important de bien écrire ses messages, les bonnes pratiques et quelques conseils pour planifier et (ré)écrire un bon historique de commit.

## Langages disponnibles
...
En quelques mots, un commit est un __snapshot__, un instantané de vos branches locales dans votre dépôt local.
Contrairement à ce que certaines personnes pensent, [git ne sauvegarde pas seulement la différences entre les fichiers, mais enregistre une version complète de chaque fichiers](https://git-scm.com/book/eo/v1/Ekkomenci-Git-Basics#Snapshots,-Not-Differences).
Pour les fichiers qui n'ont pas de modifications d'un commit à un autre, git enregistre seulement un lien vers le dernier fichier identique déjà enregistré.

L'image ci-dessous montre comment git sauvegarde les données en fonction du temps, où à chaque "Version" correspond à un commit :
